...
c = myContract.at('0xe18a9c0c06f39189dafff8d350b4bd1b21db6e0b');

	$("#btnapply").click(function() {
		$("#clientdata").text("");
		$("#clientdata").append("משקל: 72 קג\n");
		$("#clientdata").append("גובה: 178 סמ\n");
		if (c.isPermissioned(web3.eth.accounts[1], web3.eth.accounts[0], {from:web3.eth.accounts[1], gas:300000})) {

			$("#clientdata").append("אלרגיות: פול, מים, אורז\n");
			$("#clientdata").append("נטייה ללחץ דם גבוה\n");
			$("#clientdata").append("בסיכון גבוה לסרטן העור\n");
			$("#clientdata").append("חשד לבעיות פוריות\n");
		}
	});
});
